...
set CLASSPATH=%APP_HOME%\lib\DevelNext.jar


@rem Execute develnext
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEVELNEXT_OPTS%  -classpath "%CLASSPATH%" php.runtime.launcher.Launcher %*
...
if not ""=="%DEVELNEXT_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
